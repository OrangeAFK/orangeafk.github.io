...
const header = {
  homepage: 'https://orangeafk.github.io/vjs', // URL for the homepage - !!! IMPORTANT: UPDATE THIS TO YOUR OFFICIAL WEBSITE LINK BEFORE DEPLOYING!!!!
  title: 'VJS', // Title shown in left of the navigation bar
}
